...
- ✅ Smart senior rate syncing (only when rate changes detected)
...
- ✅ Gas optimization (skips unnecessary transactions)
...
| `EPOCH_MANAGER_ADDRESS` | `0x7cbdd2d816C4d733b36ED131695Ac9cb17684DC3` | ⚪ Optional (default provided) |
| `CORE_VAULT_ADDRESS` | `0x6D418348BFfB4196D477DBe2b1082485F5aE5164` | ⚪ Optional (default provided) |
| `SAFETY_MODULE_ADDRESS` | `0xE2fa3596C8969bbd28b3dda515BABb268343df4B` | ⚪ Optional (default provided) |
...
│  ┌───────────────────────────────────────────────────┐  │
│  │ 1. Check Senior Rate Sync                         │  │
│  │    - Read CoreVault.baseRate()                    │  │
│  │    - Read SafetyModule.getSeniorTargetAPY()       │  │
│  │    - If mismatch: sync rate (save gas!)           │  │
│  │    - If match: skip transaction                    │  │
│  │                                                     │  │
│  │ 2. Check Epoch Status                              │  │
│  │    - Fetch current epoch data                      │  │
│  │    - Check if epoch.endTime < block.timestamp      │  │
│  │                                                     │  │
│  │ 3. If Epoch Ended:                                 │  │
...
✅ Rates are in sync. No action needed.
...
⚠️  Rate mismatch detected! Syncing required.
Calling syncSeniorRateFromSafetyModule()...

📝 Transaction Hash: 0xdef789abc123...
🔗 Explorer: https://sepolia.mantlescan.xyz/tx/0xdef789abc123...
✅ Senior rate synced successfully!
   Base Rate: 8.00% → 9.00%
