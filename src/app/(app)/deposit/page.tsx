  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8 animate-fade-in">
      <div className="text-center">
        ...
        <p className="text-lg text-zinc-600 text-muted-foreground">
      ...
      {!isConnected && (
        <Card className="border-2 border-orange-200 border-accent/30 bg-linear-to-br from-orange-50 to-orange-100/50 from-card to-card shadow-lg">
          <CardContent className="p-6 flex items-center gap-4">
            <div className="p-3 rounded-full bg-orange-100 bg-accent/10">
              <AlertCircle className="h-6 w-6 text-orange-600 text-accent" />
            </div>
            <div>
              <p className="font-semibold text-orange-900 text-accent mb-1">
                Wallet Not Connected
              </p>
              <p className="text-sm text-orange-800 text-muted-foreground">
      ...
      {amount && Number(amount) > 0 && (
        <Card className="border-2 border-zinc-200 border-border shadow-xl animate-fade-in-up">
          <CardContent className="p-6 space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 rounded-lg bg-zinc-50 bg-background">
                <span className="text-sm font-medium text-zinc-600 text-muted-foreground">
                  Tranche
                </span>
      ...
      {/* Info */}
      <Card className="border-2 border-blue-200 border-primary/30 bg-linear-to-br from-blue-50 to-blue-100/50 from-card to-card shadow-lg">
        <CardContent className="p-6 space-y-3">
          <h4 className="font-bold text-lg text-blue-900 text-primary flex items-center gap-2">
            <span className="text-xl">ℹ️</span>
            Important Information
          </h4>
          <ul className="space-y-2 text-sm text-blue-800 text-foreground">
            <li className="flex items-start gap-2">
              <span className="text-blue-600 text-primary mt-0.5">•</span>
              <span>
